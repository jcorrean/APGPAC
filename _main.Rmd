...
En las ciencias de datos, además de R, Python es un lenguaje de programación muy utilizado. Afortunadamente Python y R son integrables dentro de RStudio usando la librería reticulate que instalaremos de la misma manera aplicada para instalar otras librerías.
...
Ahora, pasamos a insertar un chunk para Python para invocar las librerías de Python que vamos a usar en el siguiente ejemplo.
...
<!--chapter:end:04-ProyectoTolima.Rmd-->
