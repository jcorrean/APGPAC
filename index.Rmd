...
# <span style="color: #ECD22D;">Sobre la edición de este libro</span> {.unnumbered}

Este libro resume las lecciones del curso de "<span style="color: #EC2D3B;">**Analítica para Proyectos**</span>" de la [<span style="color: #EC2D3B;">**Maestría en Estructuración Ágil de Proyectos de Alta Complejidad**</span>](https://urosario.edu.co/en/node/681) de la
